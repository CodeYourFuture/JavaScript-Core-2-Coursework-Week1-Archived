...
for(let profiles of people) {
    ...
    for (let friend of profiles.friends) {
        // console.log(friend.name);
        if (friend.name === "Stacie Villarreal") {
            friendsWithStacie.push(profiles.name.first + " " +profiles.name.last)
        }
    }
}
...
for (let profiles of people) {
  for (let trait of profiles.friends) {
      for (let n of trait.skills){
        // console.log(n)
           if (n === "Multi-tasking") {
