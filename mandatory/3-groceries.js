...
for (let obj in weeklyMealPlan) {
  weeklyMealPlan[obj].forEach((item, idx) => {
...
for (let obj in weeklyMealPlan) {
  let totalItems = weeklyMealPlan[obj].length;
  numberOfItemsPerWeek[obj] = totalItems;
}
