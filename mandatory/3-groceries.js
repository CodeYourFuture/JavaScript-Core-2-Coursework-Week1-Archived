...
// Needed a little nudge to get this right
let weeklyGroceriesToBuy = [];
for (let [_, foodItems] of Object.entries(weeklyMealPlan)) {
  foodItems.forEach(function isRepeated(element) {
...
for (let [key, foodItems] of Object.entries(weeklyMealPlan)) {
...
// I had help with this exercise - I was making it more complex that it required
for (let [key, foodItems] of Object.entries(weeklyMealPlan)) {
  numberOfItemsPerWeek[key] = foodItems.length;
}
