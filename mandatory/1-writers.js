...
writers.map(item => console.log(`Hi, my name is ${item.firstName} ${item.lastName}. I am ${item.age} years old, and work as a ${item.occupation}.`))
};
...
function logDeadWritersInTheirForties() {
  ...
  writers.map(item => (item.age >= 40 && item.age <50 && item.alive === false) && console.log(`Writer ${item.firstName} ${item.lastName} died at ${item.age} years old.`))
}
...
function logAliveWritersInTheirForties() {
  // write your code here
  writers.map(item => (item.age >= 40 && item.age <50 && item.alive === true) && console.log(`Hi, my name is ${item.firstName} ${item.lastName}. I am ${item.age} years old.`))
}
