...
function logDeadWritersInTheirForties() {
  ...
  const writersDeadBetweenFortyAndFortyNine = writers
    .filter(
  ...
  return writersDeadBetweenFortyAndFortyNine;
}

// const filteredDeadWriters = writersDeadBetweenFortyAndFortyNine.
...
function logAliveWritersInTheirForties() {
  // write your code here
  const writersAliveBetweenFortyAndFortyNine = writers
  ...
  return writersAliveBetweenFortyAndFortyNine;
}
