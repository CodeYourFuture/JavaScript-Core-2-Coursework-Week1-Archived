...
function logAllWriters() {
  ...
  writers.forEach((array) =>
    console.log(
      `Hi, my name is ${array.firstName} ${array.lastName}. I am ${array.age} years old, and work as a ${array.occupation}.`
    )
  );
}
...
function logDeadWritersInTheirForties() {
  ...
  writers.forEach((array) => {
    if (array.age >= 40 && array.age <= 50 && array.alive === false) {
      console.log(
...
function logAliveWritersInTheirForties() {
  // write your code here
  writers.forEach((array) => {
    if (array.age >= 40 && array.age <= 50 && array.alive === true) {
      console.log(
