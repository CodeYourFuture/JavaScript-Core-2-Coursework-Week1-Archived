...
let bottle = {
  ...
  pour: function () {
    if (!this.isFull()) {
      ...
      console.log(
        "The bottle is full. You can't add 10 more units. Drink some off."
      );
    }
...
Extra question:
  ...
  Since we are working inside the object bottle we want to refer to it using this. because it refers to the object and lets us work with it. 
*/
