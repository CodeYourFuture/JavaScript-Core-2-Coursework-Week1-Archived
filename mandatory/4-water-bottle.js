...
let bottle = {
  ...
  pour: function () {
    return (this.volume + 10 > 100 ? this.volume = 100 : this.volume += 10);
    // calling this function should increase your bottle volume by 10 units;
  },
  drink: function () {
    return (this.volume - 10 < 0 ? this.volume = 0 : this.volume -= 10);
...
*/
I think "this" is preferred because then you know that you are only referring to or accessing something inside the current object that you are using, and removes any ambiguity. There may also be other objects with similar names that may otherwise cause confusion.
