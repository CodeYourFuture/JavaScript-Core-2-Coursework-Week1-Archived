...
let bottle = {
  ...
  pour: function () {
    ...
    if(this.volume >= 0 && this.volume <= 90) this.volume += 10;
    else if(this.volume > 90 && this.volume < 100) this.volume += (100 - this.volume);
    else if(this.volume === 100) this.volume = 100;
  },
  drink: function () {
...
//   This keyword is a better practice in terms of simplicity, and also for debugging reasons. Using variable name could cause confusion where there are many global variables, whereas this specifically states the object. 
/*
