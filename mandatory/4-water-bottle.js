...
// Write you answer to the question here: if we decide to copy the object and assign it to another variable name, then using the object name with the property name in the object method throws an error. 
