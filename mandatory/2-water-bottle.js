...
let bottle = {
  ...
  pour: function () {
    // calling this function should increase your bottle volume by 10 units to max capacity;
    if (this.volume <= 90) {
  ...
  drink: function () {
    // calling this function should decrease your bottle volume by 10 units if there is enough;
    if (this.volume < 10) {
      this.volume = 0;
    } else {
      this.volume = this.volume - 10;
