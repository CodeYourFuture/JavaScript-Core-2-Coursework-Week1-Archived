...
let bottle = {
  ...
  pour: function () {
    this.volume = this.volume + 10;// calling this function should increase your bottle volume by 10 units;
  },
  drink: function () {
   this.volume = this.volume - 10; // calling this function should decrease your bottle volume by 10 units;
  },
  isFull: function () {
    if (this.volume === 100){
      return true;
