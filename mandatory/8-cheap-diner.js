...
function chooseMeal(mealArray) {
  ...
  if (mealArray.length === 0) {
    ...
    //if the array has 2 or more objects
    ...
    return ('mealArray sorted', mealArray[1].name);
    //print the 2nd(index 1) object key
  }
  else (mealArray.length === 1)
  //if there is only 1 object in the array
  return mealArray[0].name;
  //print the key of that 1 object
}
