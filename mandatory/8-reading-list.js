...
test("books are logged", function () {
  expectLogBooksToLog([
    "You still need to read Skulduggery Pleasant by Derek Landy",
    "You still need to read The Last Wish by Andrzej Sapkowski",
    "You still need to read Sword of Destiny by Andrzej Sapkowski",
    "You've already read The Art of War by Sun Tzu",
    "You've already read An Inspector Calls by J. B. Priestley",
  ]);
});
