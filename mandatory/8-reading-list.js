...
test("books are logged", function () {
  expectLogBooksToLog([
    "You've already read Netherland by Joseph O'Neill",
    "You still need to read The Shining by Stephen King",
    "You've already read The Da Vinci Code by Dan Brown",
    "You've already read The Return of The Native by Thomas Hardy",
