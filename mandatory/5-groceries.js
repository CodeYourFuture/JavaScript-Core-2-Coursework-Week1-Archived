...
let weeklyGroceriesObject = {};



for (day in weeklyMealPlan) {
  let shopping = weeklyMealPlan[day];
  
  for (var i = 0; i < shopping.length; i++) {
    weeklyGroceriesObject[shopping[i]] = true ;
   
  }
  let weeklyGroceriesToBuy = Object.keys(weeklyGroceriesObject);
 
  console.log(weeklyGroceriesToBuy, weeklyGroceriesObject);
}
