...
let arrayDays = Object.keys(weeklyMealPlan);
arrayDays.map(day => {
  weeklyMealPlan[day].map (ingredient => {
...
let arrayWeekendDays = arrayDays.slice(arrayDays.length-2);
arrayWeekendDays.map(day =>{
  weeklyMealPlan[day].map (ingredient => {
